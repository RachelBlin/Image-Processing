...
path_folder = "AOP_filtre_median/couvert_fm"
...
plt.title("AOP médian couvert fin de matinée")
plt.savefig("graphiques/AOP/filtre_median/couvert_fm_med.png")
plt.show()

plt.figure(2)
plt.hist(y_axis, int(len(files)/5))
plt.savefig("graphiques/AOP/filtre_median/hist_couvert_fm_med.png")
plt.show()
